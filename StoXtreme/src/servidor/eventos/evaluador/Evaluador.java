/* Generated By:JavaCC: Do not edit this line. Evaluador.java */
        ...
        public class Evaluador implements EvaluadorConstants {
                ...
                public boolean evalua(Hashtable variables) throws ParseException{
  ...
  final public String[] E0() throws ParseException {
               String[] ret1, ret2; String[] ret = new String[2];
    ret1 = E1();
  ...
  final public String[] E1() throws ParseException {
               String[] ret1, ret2; String[] ret = new String[2];
    ret1 = E2();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case AND:
  ...
  final public String[] E2() throws ParseException {
               String op; String[] ret1, ret2; String[] ret = new String[2];
    ret1 = E3();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case MENORIGUAL:
    case MAYORIGUAL:
  ...
  final public String OpComp() throws ParseException {
    ...
    case MENORIGUAL:
      jj_consume_token(MENORIGUAL);
                      {if (true) return "menor_igual";}
      break;
    case MAYORIGUAL:
      jj_consume_token(MAYORIGUAL);
                      {if (true) return "mayor_igual";}
      break;
    case IGUALDAD:
  ...
  final public String[] E3() throws ParseException {
               String op; String[] ret1, ret2; String[] ret = new String[2];
    ret1 = E4();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case MAS:
  ...
  final public String OpSum() throws ParseException {
                String s;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case MAS:
  ...
  final public String[] E4() throws ParseException {
               String op; String[] ret1, ret2; String[] ret = new String[2];
    ret1 = E5();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case POR:
  ...
  final public String OpMul() throws ParseException {
                String s;Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case POR:
      jj_consume_token(POR);
               {if (true) return "multiplica";}
      break;
    case ENTRE:
      jj_consume_token(ENTRE);
                 {if (true) return "divide";}
      break;
    case MOD:
      jj_consume_token(MOD);
               {if (true) return "modulo";}
      break;
    default:
      jj_la1[7] = jj_gen;
      jj_consume_token(-1);
  ...
  final public String[] E5() throws ParseException {
               String[] ret1; String[] ret = new String[2]; boolean not = false;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NOT:
  ...
  final public String[] E6() throws ParseException {
               String[] ret = new String[2]; Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case PAP:
    ...
    case VAR:
      t = jj_consume_token(VAR);
                        ...
                        if(!variables.containsKey(t.image))
                                {if (true) throw new ParseException("Error: No existe la variable "+t.image);}
                        ret[1] = variables.get(t.image).toString();
                        variablesUsadas.add(t.image);
      break;
    case NUMERO:
      t = jj_consume_token(NUMERO);
                    ret[0] = "double"; ret[1] = t.image;
      break;
    case TRUE:
      jj_consume_token(TRUE);
                ret[0] = "boolean"; ret[1] = "true";
      break;
    case FALSE:
      jj_consume_token(FALSE);
                 ret[0] = "boolean"; ret[1] = "false";
      break;
    default:
      jj_la1[9] = jj_gen;
      jj_consume_token(-1);
